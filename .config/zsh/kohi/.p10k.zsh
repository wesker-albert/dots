# Generated by Powerlevel10k configuration wizard on 2023-03-28 at 21:50 PDT.
...
# 12h time, 2 lines, dotted, no frame, white-ornaments, sparse, few icons, fluent,
...
() {
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_TIME_VISUAL_IDENTIFIER_EXPANSION="󱑁 "
  # Custom prefix.
